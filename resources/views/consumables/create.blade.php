	        ...
	        <div class="col-md-8">
	            <div class="card">
	                <div class="card-header bg-orange">
	   				Gerecht toevoegen
	   				<a class="btn btn-primary" href="{{ route('consumables.index', ['restaurant_id' => $restaurant_id]) }}">Terug naar het menu</a>
	                </div>

	                <div class="card-body">
	                    <form method="POST" enctype="multipart/form-data" action="{{ route('consumables.store') }}">
	                        @csrf
