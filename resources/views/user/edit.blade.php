...
<div class="container">
        <div class="row">
            <div class="col-md-11 col-md-offset-1">
                <div class="card">
                    <h5 class="card-header bg-orange">Your account details</h5>
                    <div class="card-body">
                        <h5 class="card-title">Wijzig uw account gegevens.</h5>

                        <form enctype="multipart/form-data" method="post" action="{{ route('edit', Auth::id()) }}">
                     	    @method('PATCH')
                            @csrf
